  ...
  <div>
    ...
    >
      ...
      >
        <Row :gutter="16">
          <Col span="12">
            <FormItem label="银行名称" prop="bankName">
              <Input
                v-model="formModel.fields.bankName"
                placeholder="请输入银行名称"
                style="width: 400px"
              />
            </FormItem>
        ...
        <Row :gutter="16">
          <Col span="12">
            <FormItem label="位置" prop="bankAddress">
              <Input
                v-model="formModel.fields.bankAddress"
                placeholder="请输入位置"
                style="width: 400px"
              />
            </FormItem>
...
import {
  ...
  batchCommand,
  deleteFood,
} from "@/api/intelligenttravel/bank";
...
export default {
  ...
  computed: {
    ...
    selectedRowsId() {
      return this.formModel.selection.map((x) => x.bankUuid);
    },
  },
  methods: {
