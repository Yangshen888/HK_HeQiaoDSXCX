  ...
  <div>
    ...
    >
      ...
      >
        <Row :gutter="16">
          <Col span="12">
            <FormItem label="3A公厕名称" prop="gtoiletName">
              <Input
                v-model="formModel.fields.gtoiletName"
                placeholder="请输入3A公厕名称"
                style="width: 400px"
              />
            </FormItem>
          </Col>
        ...
        <Row :gutter="16">
          <Col span="12">
            <FormItem label="位置" prop="gtoiletAddress">
              <Input
                v-model="formModel.fields.gtoiletAddress"
                placeholder="请输入位置"
                style="width: 400px"
              />
            </FormItem>
        ...
        <Row :gutter="16">
          <Col span="12">
            <FormItem label="使用情况" prop="gtoiletStaues">
              <Input
                v-model="formModel.fields.gtoiletStaues"
                placeholder="请输入使用情况"
                style="width: 400px"
              />
            </FormItem>
        ...
        <Row :gutter="16">
          <Col span="12">
            <FormItem label="空气质量" prop="kongqiZhil">
              <Input
                v-model="formModel.fields.kongqiZhil"
                placeholder="请输入空气质量"
                style="width: 400px"
              />
            </FormItem>
        ...
        <Row :gutter="16">
          <Col span="12">
            <FormItem label="水量预警" prop="waterYujin">
              <Input
                v-model="formModel.fields.waterYujin"
                placeholder="请输入水量预警"
                style="width: 400px"
              />
            </FormItem>
...
export default {
  ...
  methods: {
    ...
    handleEdit(row) {
      ...
      this.doLoadFood(row.gtoiletUuid);
    },
    handleShow(row) {
