  ...
  <div>
    ...
    >
      ...
      >
        <!-- <Row :gutter="16">
          <Col span="12">
            <FormItem label="公交线路名称" prop="name">
              <Input
        ...
        <Row :gutter="16">
          <Col span="12">
            <FormItem label="起点" prop="begainSite">
              <Input
                v-model="formModel.fields.begainSite"
                placeholder="请输入起始站"
                style="width: 400px"
              />
            </FormItem>
        ...
        <Row :gutter="16">
          <Col span="12">
            <FormItem label="终点" prop="endSite">
              <Input
                v-model="formModel.fields.endSite"
                placeholder="请输入终点站"
                style="width: 400px"
              />
            </FormItem>
        ...
        <!-- <Row :gutter="16">
          <Col span="12">
            <FormItem label="线路介绍" prop="introduction">
              <Input
        ...
        <!-- <FormItem label="内容" label-position="top" prop="introduction">
          <quill-editor v-model="formModel.fields.introduction"></quill-editor>
        </FormItem> -->

        <!-- <Row :gutter="16">
          <Col span="12">
            <FormItem label="起始时间" prop="begainTime">
              <Input
                v-model="formModel.fields.begainTime"
                placeholder="请输入起始时间"
                style="width: 400px"
              />
            </FormItem>
        ...
        <Row :gutter="16">
          <Col span="12">
            <FormItem label="末班时间" prop="endTime">
              <Input
    ...
    >
      ...
      >
        ...
        <!-- <fieldset>
          ...
          <Row style="padding: 15px">
            <div v-html="formModel.fields.introduction">{{formModel.fields.introduction}}</div>
          </Row>
        </fieldset> -->
...
export default {
  ...
  computed: {
    ...
    selectedRowsId() {
      return this.formModel.selection.map((x) => x.busUuid);
    },
  },
  methods: {
        ...
        if (res.data.data.picture != null && res.data.data.picture != "") {
          ...
          for (let i = 0; i < list.length; i++) {
            this.uploadList.push({
              url: config.baseUrl.dev + "UploadFiles/Xing/" + list[i],
              status: "finished",
              name: "UploadFiles/Xing/" + list[i],
              fileName: list[i],
            });
          }
        }
