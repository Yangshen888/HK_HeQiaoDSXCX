  ...
  <div>
    ...
    >
      ...
      >
        ...
        <Row :gutter="16">
          <Col span="12">
            <FormItem label="景区介绍" prop="spotContent">
              <Input
...
import {
  ...
  batchCommand,
  deletetoFile,
} from "@/api/Tourismiffo/Tourismiffo";
...
export default {
  ...
  computed: {
    ...
    selectedRowsId() {
      return this.formModel.selection.map((x) => x.tourismUuid);
    },
  },
  methods: {
    ...
    handleEdit(row) {
      ...
      this.doLoadScenicspot(row.tourismUuid);
    },
    handleShow(row) {
