...
namespace HeqiaoDaoshiCore.DAL
{
	...
	public partial class CulturalIntroduc
	{
		...
		public int GetMaxId()
		{
		return DbHelperSql.GetMaxId("ID", "CulturalIntroduc"); 
		}

		/// <summary>
		/// 是否存在该记录
		/// </summary>
		public bool Exists(Guid CulturalIntroducUUID,int ID)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from CulturalIntroduc");
			strSql.Append(" where CulturalIntroducUUID=@CulturalIntroducUUID and ID=@ID ");
			SqlParameter[] parameters = {
					new SqlParameter("@CulturalIntroducUUID", SqlDbType.UniqueIdentifier,16),
					new SqlParameter("@ID", SqlDbType.Int,4)			};
			parameters[0].Value = CulturalIntroducUUID;
		...
		/// 增加一条数据
		/// </summary>
		public int Add(HeqiaoDaoshiCore.Model.CulturalIntroduc model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into CulturalIntroduc(");
			strSql.Append("CulturalIntroducUUID,Title,ReleaseTime,IsRelease,Cover,Content,AddTime,AddPeople,IsDeleted,Photo)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(HeqiaoDaoshiCore.Model.CulturalIntroduc model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update CulturalIntroduc set ");
			...
			parameters[9].Value = model.CulturalIntroducUUID;
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from CulturalIntroduc ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
		...
		/// 删除一条数据
		/// </summary>
		public bool Delete(Guid CulturalIntroducUUID,int ID)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public HeqiaoDaoshiCore.Model.CulturalIntroduc DataRowToModel(DataRow row)
		{
			HeqiaoDaoshiCore.Model.CulturalIntroduc model=new HeqiaoDaoshiCore.Model.CulturalIntroduc();
			if (row != null)
			{
				if(row["CulturalIntroducUUID"]!=null && row["CulturalIntroducUUID"].ToString()!="")
				{
					model.CulturalIntroducUUID= new Guid(row["CulturalIntroducUUID"].ToString());
				}
				if(row["Title"]!=null)
				{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select CulturalIntroducUUID,Title,ReleaseTime,IsRelease,Cover,Content,AddTime,AddPeople,ID,IsDeleted,Photo ");
			strSql.Append(" FROM CulturalIntroduc ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" CulturalIntroducUUID,Title,ReleaseTime,IsRelease,Cover,Content,AddTime,AddPeople,ID,IsDeleted,Photo ");
			strSql.Append(" FROM CulturalIntroduc ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from CulturalIntroduc T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "CulturalIntroduc";
			parameters[1].Value = "ID";
