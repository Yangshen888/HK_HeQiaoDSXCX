...
namespace HeqiaoDaoshiCore.DAL
{
	...
	public partial class Mark
	{
		...
		public int GetMaxId()
		{
		return DbHelperSql.GetMaxId("ID", "Mark"); 
		}

		/// <summary>
		/// 是否存在该记录
		/// </summary>
		public bool Exists(Guid MarkUUID,int ID)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from Mark");
			strSql.Append(" where MarkUUID=@MarkUUID and ID=@ID ");
			SqlParameter[] parameters = {
					new SqlParameter("@MarkUUID", SqlDbType.UniqueIdentifier,16),
					new SqlParameter("@ID", SqlDbType.Int,4)			};
			parameters[0].Value = MarkUUID;
		...
		/// 删除一条数据
		/// </summary>
		public bool Delete(Guid MarkUUID,int ID)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public HeqiaoDaoshiCore.Model.Mark GetModel(int ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,CreateTime,MarkUUID,MarkName,MarkPicture,IsDelete from Mark ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
			...
			HeqiaoDaoshiCore.Model.Mark model=new HeqiaoDaoshiCore.Model.Mark();
		...
		/// 得到一个对象实体
		/// </summary>
		public HeqiaoDaoshiCore.Model.Mark DataRowToModel(DataRow row)
		{
			HeqiaoDaoshiCore.Model.Mark model=new HeqiaoDaoshiCore.Model.Mark();
			if (row != null)
			{
				...
				if(row["MarkPicture"]!=null)
				{
					model.MarkPicture=row["MarkPicture"].ToString();
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,CreateTime,MarkUUID,MarkName,MarkPicture,IsDelete ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,CreateTime,MarkUUID,MarkName,MarkPicture,IsDelete ");
			strSql.Append(" FROM Mark ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
