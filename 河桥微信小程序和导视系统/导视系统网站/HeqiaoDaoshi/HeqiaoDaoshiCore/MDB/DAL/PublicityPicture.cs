...
namespace HeqiaoDaoshiCore.DAL
{
	...
	public partial class PublicityPicture
	{
		...
		public int GetMaxId()
		{
		return DbHelperSql.GetMaxId("ID", "PublicityPicture"); 
		}
		...
		public bool Exists(Guid PublicityPictureUUID,int ID)
		{
			...
			strSql.Append("select count(1) from PublicityPicture");
			strSql.Append(" where PublicityPictureUUID=@PublicityPictureUUID and ID=@ID ");
			SqlParameter[] parameters = {
					new SqlParameter("@PublicityPictureUUID", SqlDbType.UniqueIdentifier,16),
					new SqlParameter("@ID", SqlDbType.Int,4)			};
			parameters[0].Value = PublicityPictureUUID;
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from PublicityPicture ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select PublicityPictureUUID,Title,ReleaseTime,IsRelease,Cover,Content,AddTime,AddPeople,ID,IsDeleted,Photo ");
			strSql.Append(" FROM PublicityPicture ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" PublicityPictureUUID,Title,ReleaseTime,IsRelease,Cover,Content,AddTime,AddPeople,ID,IsDeleted,Photo ");
			strSql.Append(" FROM PublicityPicture ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from PublicityPicture T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "PublicityPicture";
			parameters[1].Value = "ID";
