                        ...
                        <div style="overflow: scroll; overflow-y: hidden; height: 530px;">
                            <div <%=styles %>>
                                <asp:Repeater ID="Repeater1" runat="server">
                                    <ItemTemplate>
                                        <div style="float: left; width: 525px; height: 420px; margin-left: 38px; margin-top: 80px; cursor: pointer;">
                                            <img src="<%# geturl(Eval("FMPicture").ToString()) %>" width="523" height="329" />
                                            <span style="display: block; text-align: center; font-size: 25px; color: #fff; margin-top: 10px;"><%#  Eval("TourGuideName") %></span>
                                        </div>
                                    </ItemTemplate>
                                </asp:Repeater>
                            </div>
