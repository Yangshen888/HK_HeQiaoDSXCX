            ...
            <div class="main_l">
                <div class="mainHead">
                    ...
                    <div style="float: left;position: absolute;top: 50%;transform: translateY(-50%);left: 12%;">
                        <img src="./images/new/jqzx2.png" alt="">
                    </div>
                    <!-- 返回按钮 -->
                ...
                <div class="mainCon">
                    ...
                    <asp:Repeater ID="Repeater1" runat="server">
                        <ItemTemplate>
                            <div class="sinceBox">
                                <div class="title">
                                    <p style="font-size: 36px;letter-spacing: 4px;"><%# Eval("Title").ToString() %></p> 
                                    <img src="./images/new/yun.png" alt="">
                                </div>
                                <div class="imgBox">
                                    <ul>
                                        <li>
                                            <img src="<%# geturl(Eval("Picture").ToString()) %>" alt="" style="height: 200px;">
                                        </li>
                                        <li>
                                            <img src="<%# geturl1(Eval("Picture").ToString()) %>" alt="" style="height: 200px;">
                                        </li>
                                        <li>
                                            <img src="<%# geturl2(Eval("Picture").ToString()) %>" alt="" style="height: 200px;">
                                        </li>
                                    </ul>
                                </div>
