						...
						<view class="class-item">
							...
							<view class="item-container" style="margin-top: 15px;">
								<view class="thumb-box" v-for="(item1, index1) in item.foods" :key="index1" style="margin: 5% 0px;" :style="index1==3?'width:40%;':'width: 56%;'">
									<image class="item-menu-image" :src="baseurl+item1.icon" mode="" :style="item.name=='美食推荐'?'border-radius: 50%;width:150rpx;height:150rpx;':'border-radius: 20rpx;width:200rpx;height:150rpx;'"
