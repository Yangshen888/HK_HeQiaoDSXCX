...
<!-- 		<view style="font-size: 1.2em;margin: 20px;">
			{{"-"}}{{strategydetail.title}}{{"-"}}
		</view>
		<view style="font-size: 0.8em;margin: 20px;text-indent:1.6em">
			{{strategydetail.strategyContent}}
		</view> -->
	...
	export default{
		data(){
			return{
				...
				imglist:[],
				purl: http.baseUrl + 'UploadFiles/SpecialPick/',
			}
		},
		onLoad(opt) {
			if(opt.guid!="")
